...
class GLWrapper : IGLWrapper {
    ...
    override fun glUniformMatrix4fv(location: Int, transpose: Boolean, matrices: FloatBuffer) =
    ...
    override fun glVertexAttribIPointer(index: Int, size: Int, type: Int, stride: Int, pointer: Long) =
