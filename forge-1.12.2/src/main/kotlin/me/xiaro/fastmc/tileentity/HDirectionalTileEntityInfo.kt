...
import me.xiaro.fastmc.tileentity.info.IHDirectionalTileEntityInfo
import me.xiaro.fastmc.util.getPropertyOrDefault
import net.minecraft.block.properties.PropertyEnum
import net.minecraft.tileentity.TileEntity
import net.minecraft.util.EnumFacing

open class HDirectionalTileEntityInfo<E: TileEntity>(private val property: PropertyEnum<EnumFacing>) : TileEntityInfo<E>(),
