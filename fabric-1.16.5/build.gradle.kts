                    ...
                    """
                        <component name="ProjectRunConfigurationManager">
                          <configuration default="false" name="${project.name} runClient" type="Application" factoryName="Application">
                            ...
                            <option name="VM_PARAMETERS" value="-Dfabric.dli.config=${'$'}PROJECT_DIR$/${project.name}/.gradle/loom-cache/launch.cfg -Dfabric.dli.env=mixin -Dfabric.dli.main=net.fabricmc.loader.launch.knot.KnotClient" />
