...
class TerrainRendererImpl(renderer: me.luna.fastmc.shared.renderer.WorldRenderer) : TerrainRenderer(
    ...
    override val viewDistance: Int
        get() = mc.options.viewDistance.value
    ...
    override fun update() {
        ...
        Entity.setRenderDistanceMultiplier(
            MathHelper.clamp(
                mc.options.viewDistance.value / 8.0,
                1.0,
                2.5
            ) * mc.options.entityDistanceScaling.value
        )
            ...
            neighbor.isEmpty -> {
                ...
                when (coveredSideCache.get(hash)) {
                    ...
                    BYTE_FALSE -> {
                        ...
                        val slicedA = SlicedVoxelShape(a, axis, a.voxels.getSize(axis) - 1)
