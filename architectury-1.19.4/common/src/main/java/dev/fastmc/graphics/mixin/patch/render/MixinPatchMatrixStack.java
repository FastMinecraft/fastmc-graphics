...
public class MixinPatchMatrixStack {
    ...
    public void translate(double x, double y, double z) {
        ...
        (entry.getPositionMatrix()).translate((float) x, (float) y, (float) z);
    }
    ...
    public void scale(float x, float y, float z) {
        ...
        (entry.getNormalMatrix()).scale(i * x, i * y, i * z);
    }
    ...
    public void push() {
        ...
        (newEntry.getPositionMatrix()).set(entry.getPositionMatrix());
        (newEntry.getNormalMatrix()).set(entry.getNormalMatrix());
