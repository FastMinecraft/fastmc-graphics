...
class StaticBitSet : MutableSet<Int> {
    ...
    constructor(other: StaticBitSet) {
    ...
    fun addAll(elements: StaticBitSet): Boolean {
    ...
    fun removeAll(elements: StaticBitSet): Boolean {
    ...
    fun containsAll(elements: StaticBitSet): Boolean {
