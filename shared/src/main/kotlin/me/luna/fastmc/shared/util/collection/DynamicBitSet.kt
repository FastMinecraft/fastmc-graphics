...
class DynamicBitSet : MutableSet<Int> {
    ...
    constructor(other: DynamicBitSet) {
    ...
    fun addAll(elements: DynamicBitSet): Boolean {
    ...
    fun removeAll(elements: DynamicBitSet): Boolean {
    ...
    fun containsAll(elements: DynamicBitSet): Boolean {
